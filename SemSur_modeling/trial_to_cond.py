...
ttest['parameter']=['T', 'p']
ttest.to_csv("/Users/ringelblume/Desktop/GitHub/Semantic_Surprise_N400/Condition_based_analysis/ttest.csv", sep=";")
    

################# Plots für eine Beispiel-VP:
sns.boxplot(x='deviant',y='baysur',data=dat)
plt.savefig("/Users/ringelblume/Desktop/GitHub/Semantic_Surprise_N400/Condition_based_analysis/boxplot_SemSur_by_condition.jpg", dpi=400)
plt.close()
